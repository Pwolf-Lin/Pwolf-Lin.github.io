...
var precacheConfig = [["/img/favcion.png", "e02488f887ee978e139945973541f1ac"] ["/mainfest.json", "4ea3c9cebfe8a7325ee37a1c98d517a6"]];
...
var stripIgnoredUrlParameters = function(originalUrl, ignoreUrlParametersMatching) {
    ...
    .map(function(kv) {
        return kv.split('=');
        // 分割每个 'key=value' 字符串成 [key, value] 形式
    }).filter(function(kv) {
        return ignoreUrlParametersMatching.every(function(ignoredRegex) {
            return !ignoredRegex.test(kv[0]);
            // 如果 key 没有匹配到任何忽略参数正则，就 Return true
        });
    }).map(function(kv) {
        return kv.join('=');
        // 重新把 [key, value] 格式转换为 'key=value' 字符串
    }).join('&');
    // 将所有参数 'key=value' 以 '&' 拼接
    ...
    return function e(t, n, r) {
                ...
                i.openCache(n).then(function(t) {
                    return t.match(e).then(function(e) {
                        var t = n.cache || o.cache
                          , r = Date.now();
                        if (i.isResponseFresh(e, t.maxAgeSeconds, r))
                            return e
                    })
                })
            }
        ...
        15: [function(e, t, n) {
            function r(e, t) {
                ...
                return i < e.length && (c += e.substr(i)),
                c && r.push(c),
                r
            }
            function o(e, t) {
            ...
            function m(e, t, n) {
                ...
                for (var r = n.strict, o = n.end !== !1, i = "", c = 0; c < e.length; c++) {
                    ...
                    if ("string" == typeof s)
                        ...
                        t.push(s),
                        s.repeat && (p += "(?:" + u + p + ")*"),
                        p = s.optional ? s.partial ? u + "(" + p + ")?" : "(?:" + u + "(" + p + "))?" : u + "(" + p + ")",
                        i += p
                    }
                }
                var l = a(n.delimiter || "/")
